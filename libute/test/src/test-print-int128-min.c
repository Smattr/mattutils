/// @file
/// @brief Test printing of `INT128_MIN`
///
...
TEST("printing INT128_MIN") {
  ...
  // print INT128_MIN to this
  {
    const int128_t min = INT128_MIN;
    const int r = int128_put(min, f);
    ASSERT_GE(r, 0);
    (void)fflush(f);
  }

  ASSERT_STREQ(buffer, "-170141183460469231731687303715884105728");
}
