...
type pc_t: enum {
  SP_ACQ_L1,   -- sp_acq, asp.c:229
  SP_ACQ_L2,   -- sp_acq, asp.c:247
  SP_ACQ_L3,   -- sp_acq, asp.c:248
  SP_ACQ_L4,   -- sp_acq, asp.c:252
  SP_ACQ_L5,   -- sp_acq, asp.c:257
  SP_REL_L1,   -- dec_ref, asp.c:153
  SP_STORE_L1, -- sp_store, asp.c:295
  SP_STORE_L2, -- sp_store, asp.c:301
  SP_STORE_L3  -- dec_ref, asp.c:153
};
